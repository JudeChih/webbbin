...
<div class="page-title">
  	...
  	<div class="title_right">
		...
		@endif
		@if(isset($systemdata))
			<form class="system_form" action="/ishot-adaptive-modify" method="post" accept-charset="utf-8" style="display:none;">
	            {!! csrf_field() !!}
    	...
    	<div class="x_panel">
            @if($systemdata['sp_parametervalue'] == 2)
	            {{-- <div class="x_title">
	                ...
	                <ul class="nav navbar-right panel_toolbox">
	                    <li><a class="btn btn-default" href="/ishot-adaptive-top10"><i class="fa fa-plus"></i>編輯</a>
	                    </li>
	                </ul>
            ...
            @elseif($systemdata['sp_parametervalue'] == 2)
                <div class="x_title">
	                ...
	                <ul class="nav navbar-right panel_toolbox">
	                    <li><a class="btn btn-default" href="/ishot-create?template=adaptive"><i class="fa fa-plus"></i> 新增</a>
	                    </li>
	                </ul>
	                <div class="clearfix"></div>
            	</div>
