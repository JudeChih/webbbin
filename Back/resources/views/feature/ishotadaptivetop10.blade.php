...
@section("put_script")
<!-- 崁入各頁面的JS -->
<script type="text/javascript" src="/js/view/ishotadaptivetop10.js"></script>
@endsection
@section("content_body")
<div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-12">
    <div class="x_panel">
      	<div class="x_title">
        	<h2>編輯熱門版型推薦-固定版型<small>edit</small></h2>
        	<div class="clearfix"></div>
      	</div>
      	<div class="x_content">
            <br>
        	<form action="/ishot-adaptive-top10" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post">
                {!! csrf_field() !!}
