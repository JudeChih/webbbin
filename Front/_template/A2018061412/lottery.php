                ...
                <div class="mainnav">
                    <ul class="nav">
                       ...
                       <li id="LS-live"><a href="live.php"><span>视讯直播</span></a>
                        ...
                        <li id="LS-lottery" class="current"><a href="lottery.php"><span>彩票游戏</span></a></li>
        ...
        <div id="page-container">
            <div id="page-body">
                <div class="page_left">
                    ...
                    <div class="loginbg_01"></div>
                </div>
                <div class="page_right">
                    <div class="container_homebannerbg"></div>
                    <div class="title_lottery"></div>
                </div>
                <div class="container_shadowimg"></div>
                <div class="clearfix"></div>
                <div class="ltlottery-wrap clearfix">
