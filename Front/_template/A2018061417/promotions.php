...
<body>
            ...
            <div class="bg_shadow">
                <div id="page-header">
                        ...
                        <!-- 子選單 -->
                            <div id="nav-ball" style="display:none" class="ele-drop-group">
                                ...
                                <li id="LS-memberexclusiveii">
                                    <a href="#" class="textGlitter current"><span>优惠活动</span></a>
                                </li>
                                <li><img src="image/nav_line.png" width="2" height="70" /></li>
                    ...
                    <div class="h_01">
                        ...
                        <div class="title_memberexclusiveii">
                        </div>
                    </div>
                </div>
                <div id="page-container">
                    <div id="page-body">
                        <div class="event-wrap01">
    ...
    $("li.LS-ball, li.LS-live, li.LS-casino, li.LS-lottery").subTabs();
    $("a.MemberDate").subTabs();
    new toggleColor('.textGlitter', ['#FFF', '#FFF'], 600);
    </script>
    <script src="js/lSubTab.js"></script>
</body>
