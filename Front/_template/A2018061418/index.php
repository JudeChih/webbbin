...
<div id="mainBody">
    ...
    <div id="page-header">
        ...
        <div class="header-bottom clearfix">
            ...
            <!-- end login -->
            <!-- slideshow -->
            <div id="js-ele-slideshow" class="ele-slideshow-wrap banner-wrap">
        ...
        <div id="page-body">
            <div class="first-wrap">
                ...
                <div class="first-game-wrap clearfix">
                    ...
                    <a href="#" class="first-game first-game05"></a>
                </div>
                <!-- end first-game -->
                <!-- first btn -->
                <div class="first-btn-wrap clearfix">
                    <a href="#" class="btn-joinus"></a>
                    <a href="#" class="btn-download"></a>
                    <a href="#" class="btn-service"></a>

                    <div class="first-jp">
                        <span>1362,162.62</span>
                    </div>
                </div>
                <!-- end first btn -->
            </div>
