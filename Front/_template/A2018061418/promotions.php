    ...
    <div class="header-top clearfix">
        ...
        <div class="mainnav-wrap">
            <ul class="mainnav clearfix" data-lsub-style="fade">
                ...
                <li id="LS-memberexclusiveii" class="LS-memberexclusiveii"><a href="promotions.php" class="js-article-color current" data-color="#CF4647|#FFCC01"><span>优惠活动</span></a></li>
