            ...
            <div id="header">
                ...
                <div id="nav" class="mainnav" data-lsub-y="-10">
                    ...
                    <ul>
                        ...
                        <li class="current"><a href="promotions.php">优惠活动</a></li>
                        <li><a href="#">手机下注</a></li>
                        <li><a href="#">下载专区</a></li>
                        <li><a href="#">在线客服</a></li>
                    </ul>
        ...
        <div id="page-container">
            <div id="container_inside">
                <div id="page-casino" class="clearfix">
                    <div id="title"><img src="image/lang/zh-cn/title_memberexclusiveii.png" /></div>
                    <div class="live-wrap1">
                        <div class="promotions1"></div>
                        <div class="promotions2"></div>
                    </div>
                </div>
            </div>
        </div>
