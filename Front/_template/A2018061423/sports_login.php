...
<body>
    ...
    <div id="mainbody01">
            ...
            <div id="header">
                ...
                <div id="nav" class="mainnav" data-lsub-y="-10">
                    ...
                    <ul>
                        ...
                        <li id="LS-ball" class="current"><a href="sports_login.php">体育赛事</a>
                ...
                <div id="login">
                    ...
                    <div id="logon">
                        ...
                        <div id="member_list">
                            <a href="">下注记录</a> | <a href="">会员中心</a> | <a href="">线上存款</a> | <a href="">线上取款</a> | <a href="">额度转换</a> | <a href="">规则说明</a> | <a href="index.php">登出</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="page-container">
            <div id="gameBox-sport" class="clearfix">
                <div id="title"><img src="image/lang/zh-cn/title_sports.png" /></div>
                <div class="ball-wrap">
