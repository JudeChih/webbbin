    ...
    <div id="mainBody">
        ...
        <div id="page-casino">
            <div class="page-casino-inner">
                ...
                <div id="txt_box">
                    <div class="title_h1">MORE THAN 100 <span>GAMES TO CHOOSE FROM</span></div>
                </div>
                <div class="casino-box-img">
                    <img src="image/index_bg04_2.png" />
                </div>
                <div class="boxright">
        ...
        <div id="page-sports">
            <div id="bigsports">
                <img src="image/index_bg05_2.png" />
            ...
            <div id="txt_box">
                <ul>
                    <li class="txt_box1">
                        <div class="title_h1"><img src="image/index_sports_title.jpg" alt=""></div>
                    </li>
                    <li>
