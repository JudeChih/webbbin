    ...
    <div id="mainBody">
                ...
                <div class="header-top">
                    <div class="mainnav">
                        <ul class="nav">
                            ...
                            <li id="LS-memberexclusiveii"><a href="promotions.php" class="navlink current"><span>优惠活动</span></a></li>
        ...
        <div id="page-container">
            <div id="page-body">
                ...
                <div class="events-wrap" class="clearfix">
                    <ul class="promotions-banner">
                        <li>
                        ...
                        <li>
                            <a href="#" class="promotions-banner03"></a>
                        </li>
                    </ul>
                </div>
            </div>
