...
<body>
    <div id="mainBody" class="wrap">
                    ...
                    <div class="first-live-main clearfix">
                        <div class="first-live-content">
                            ...
                            <div class="first-live-intro">
                                24小时营运的视讯直播产品，品项多样为亚洲之冠，以清晰的直播画面提供百家乐、德州扑克、温州牌九、轮盘、番摊和骰宝等多款热门产品，保证玩家在线上浏览最即时与公平的游戏实况，在任何地点都能体验如亲临现场般刺激愉快的感官享受。此外BBIN也提供竞眯厅、金臂厅、金臂多台、与多台下注等产品选项，增加多元的投注方式，予您值得信赖的服务品质。
                            </div>
        ...
        <!-- LOGIN START-->
        <div class="login-wrap first-login logon">
            <div class="login-bg">
