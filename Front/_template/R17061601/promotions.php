        ...
        <ul class="clearfix">
            <li id="memExclusive_1" class="memExclusive">
                <a href="#0" class="promotionsImg promotions01">
                    <img src="image/pro_img01.jpg" class="orign">
                    <img src="image/pro_img01_over.jpg" class="hover">
                    <h2>2017奥运之战</br>总奖高达600,000</h2>
                </a>
            </li>
            <li id="memExclusive_2" class="memExclusive">
                <a href="#0" class="promotionsImg promotions02">
                    <img src="image/pro_img02.jpg" class="orign">
                    <img src="image/pro_img02_over.jpg" class="hover">
                    <h2>赌王之王，胜者为王</br>天天积分，月月兑换</h2>
                </a>
            </li>
            <li id="memExclusive_3" class="memExclusive">
                <a href="#0" class="promotionsImg promotions03">
                    <img src="image/pro_img03.jpg" class="orign">
                    <img src="image/pro_img03_over.jpg" class="hover">
                    <h2>彩票达人领好礼</br>周周16888送给您</h2>
                </a>
            </li>
            <li id="memExclusive_4" class="memExclusive">
                <a href="#0" class="promotionsImg promotions04">
                    <img src="image/pro_img04.jpg" class="orign">
                    <img src="image/pro_img04_over.jpg" class="hover">
                    <h2>不论输赢</br>奖励100倍有效投注即可享受免费彩金</h2>
                </a>
            </li>
            <li id="memExclusive_5" class="memExclusive">
                <a href="#0" class="promotionsImg promotions05">
                    <img src="image/pro_img05.jpg" class="orign">
                    <img src="image/pro_img05_over.jpg" class="hover">
                    <h2>VIP无以伦比</br>尊享专属的奢华礼遇</h2>
                </a>
            </li>
            <li id="memExclusive_6" class="memExclusive">
                <a href="#0" class="promotionsImg promotions06">
                    <img src="image/pro_img06.jpg" class="orign">
                    <img src="image/pro_img06_over.jpg" class="hover">
                    <h2>尊荣礼遇日日享</br>1.5%返水天天发</h2>
                </a>
            </li>
        </ul>
    </div>
