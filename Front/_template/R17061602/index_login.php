    ...
    <div id="mainBody" class="clearfix">
        ...
        <div id="page-container" class="clearfix">
            ...
            <div class="first-function-wrap">
                ...
                <!-- LOGON -->
                <div id="logon">
                    <div class="first-logon clearfix">
                        <!--首頁會員中心按鈕-->
                        ...
                        <div class="logon-list clearfix">
                            <ul>
                                ...
                                <li class="first-logon-chang"><a href="#0">额度转换</a></li>
                                <li class="first-logon-line"><a href="#0">未读讯息 <span>(1)</span></a></li>
                                <li class="first-logon-last"><a href="index.php">登出</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
