...
<body>
    ...
    <div id="mainBody" class="clearfix">
        ...
        <div id="page-header">
            <div class="page-wrap">
                <div class="memberexclusiveii-title">
                    <!-- MOBILE NAV -->
                        ...
                        <div class="page-side-fixed">
                            ...
                            <div class="page-nav mainnav-wrap">
                                <ul class="mainnav removeTextNodes clearfix">
                                    ...
                                    <li id="LS-memberexclusiveii" class="page-sub-link-active">
        ...
        <div id="page-container">
            <div id="page-body">
                <div class="page-promotion-wrap">
                    <ul class="clearfix">
                        <li class="even">
                            <a href="#0" class="promo-intro">
                                <div class="promo-img-ins">
                                    <img src="image/not-use/event01.png" alt="" class="promo-img">
                                    <img src="image/not-use/event01_over.png" alt="" class="promo-img-over">
                                </div>
                                <p class="promo-txt">这个周末最疯狂！返水强势升级。0.4%现金返水，无需投注即可提款</p>
                            </a>
                        </li>
                        <li class="even">
                            <a href="#0" class="promo-intro">
                                <div class="promo-img-ins">
                                    <img src="image/not-use/event02.png" alt="" class="promo-img">
                                    <img src="image/not-use/event02_over.png" alt="" class="promo-img-over">
                                </div>
                                <p class="promo-txt">这个周末最疯狂！返水强势升级。0.4%现金返水，无需投注即可提款</p>
                            </a>
                        </li>
                        <li class="even">
                            <a href="#0" class="promo-intro">
                                <div class="promo-img-ins">
                                    <img src="image/not-use/event03.png" alt="" class="promo-img">
                                    <img src="image/not-use/event03_over.png" alt="" class="promo-img-over">
                                </div>
                                <p class="promo-txt">这个周末最疯狂！返水强势升级。0.4%现金返水，无需投注即可提款</p>
                            </a>
                        </li>
                        <li class="even">
                            <a href="#0" class="promo-intro">
                                <div class="promo-img-ins">
                                    <img src="image/not-use/event04.png" alt="" class="promo-img">
                                    <img src="image/not-use/event04_over.png" alt="" class="promo-img-over">
                                </div>
                                <p class="promo-txt">这个周末最疯狂！返水强势升级。0.4%现金返水，无需投注即可提款</p>
                            </a>
                        </li>
                        <li class="even">
                            <a href="#0" class="promo-intro">
                                <div class="promo-img-ins">
                                    <img src="image/not-use/event05.png" alt="" class="promo-img">
                                    <img src="image/not-use/event05_over.png" alt="" class="promo-img-over">
                                </div>
                                <p class="promo-txt">这个周末最疯狂！返水强势升级。0.4%现金返水，无需投注即可提款</p>
                            </a>
                        </li>
                        <li class="even">
                            <a href="#0" class="promo-intro">
                                <div class="promo-img-ins">
                                    <img src="image/not-use/event06.png" alt="" class="promo-img">
                                    <img src="image/not-use/event06_over.png" alt="" class="promo-img-over">
                                </div>
                                <p class="promo-txt">这个周末最疯狂！返水强势升级。0.4%现金返水，无需投注即可提款</p>
                            </a>
                        </li>
