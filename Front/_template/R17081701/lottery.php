            ...
            <div class="header-main">
                    ...
                    <div class="mainnav-wrap">
                        <div class="mainnav">
                            ...
                            <ul class="clearfix">
                                ...
                                <li id="LS-lottery" class="Ls-lottery current"><a href="lottery.php"><span>彩票游戏</span></a></li>
                ...
                <div class="header-wrap">
                    <div class="page-title">
                        <img src="image/title_lottery.png">
                    </div>
                    <img src="image/title_lottery_img.png" alt="" class="page-title-img">
                    <!-- 登入前 login -->
