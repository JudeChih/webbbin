...
<body>
    <div id="mainBody" class="loading">
                    ...
                    <div class="mainnav-wrap">
                        <div class="mainnav">
                            <ul class="clearfix">
                                ...
                                <li id="LS-memberexclusiveii" class="LS-memberexclusiveii current">
        ...
        <div id="page-container">
            <div id="page-body">
                <div class="memberexclusiveii-wrap container">
                        ...
                        <ul class="clearfix">
                            <li id="memExclusive_1" class="memExclusive eventcontent-dialog">
                                <a href="#0" class="promotionsImg promotions01">
                                    <div class="ele-mem-dialog-wrap">
                                        <img src="image/not-use/event01.png" class="js-exclusive-dialog-img js-exclusive-dialog-default">
                                        <img src="image/not-use/event01_over.png" class="js-exclusive-dialog-img js-exclusive-dialog-hover">
                                    </div>
                                    <div class="ele-mem-dialog-content">
                            ...
                            <li id="memExclusive_2" class="memExclusive eventcontent-dialog">
                                <a href="#0" class="promotionsImg promotions02">
                                    <div class="ele-mem-dialog-wrap">
                                        <img src="image/not-use/event02.png" class="js-exclusive-dialog-img js-exclusive-dialog-default">
                                        <img src="image/not-use/event02_over.png" class="js-exclusive-dialog-img js-exclusive-dialog-hover">
                                    </div>
                                    <div class="ele-mem-dialog-content">
                                        <h2>最高返水1.2％不管输赢，天天玩现金返水回馈</h2>
                                    </div>
                                </a>
                            </li>
                            <li id="memExclusive_3" class="memExclusive eventcontent-dialog">
                                <a href="#0" class="promotionsImg promotions03">
                                    <div class="ele-mem-dialog-wrap">
                                        <img src="image/not-use/event03.png" class="js-exclusive-dialog-img js-exclusive-dialog-default">
                                        <img src="image/not-use/event03_over.png" class="js-exclusive-dialog-img js-exclusive-dialog-hover">
                                    </div>
                                    <div class="ele-mem-dialog-content">
                                        <h2>免费彩金8888，周周狂欢，有效投注10万即可享受</h2>
                                    </div>
                                </a>
                            </li>
                            <li id="memExclusive_4" class="memExclusive eventcontent-dialog">
                                <a href="#0" class="promotionsImg promotions04">
                                    <div class="ele-mem-dialog-wrap">
                                        <img src="image/not-use/event04.png" class="js-exclusive-dialog-img js-exclusive-dialog-default">
                                        <img src="image/not-use/event04_over.png" class="js-exclusive-dialog-img js-exclusive-dialog-hover">
                                    </div>
                                    <div class="ele-mem-dialog-content">
                                        <h2>安装客户端APP，彩金豪礼大回馈，安全可靠。</h2>
                                    </div>
                                </a>
                            </li>
                            <li id="memExclusive_5" class="memExclusive eventcontent-dialog">
                                <a href="#0" class="promotionsImg promotions05">
                                    <div class="ele-mem-dialog-wrap">
                                        <img src="image/not-use/event05.png" class="js-exclusive-dialog-img js-exclusive-dialog-default">
                                        <img src="image/not-use/event05_over.png" class="js-exclusive-dialog-img js-exclusive-dialog-hover">
                                    </div>
                                    <div class="ele-mem-dialog-content">
                                        <h2>当日最高无上限，银行卡，微信，支付宝入款，即享1％返利。</h2>
                                    </div>
                                </a>
                            </li>
                            <li id="memExclusive_6" class="memExclusive eventcontent-dialog">
                                <a href="#0" class="promotionsImg promotions06">
                                    <div class="ele-mem-dialog-wrap">
                                        <img src="image/not-use/event06.png" class="js-exclusive-dialog-img js-exclusive-dialog-default">
                                        <img src="image/not-use/event06_over.png" class="js-exclusive-dialog-img js-exclusive-dialog-hover">
                                    </div>
                                    <div class="ele-mem-dialog-content">
                                        <h2>月月送10％，老会员月月存，首存即送50％，二存再送30％。</h2>
                                    </div>
                                </a>
                            </li>
                        </ul>
