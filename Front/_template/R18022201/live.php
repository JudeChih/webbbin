    ...
    <div id="mainBody">
        ...
        <div id="page-header">
                ...
                <div class="mainnav">
                    <ul class="clearfix">
                        ...
                        <li id="LS-live" class="LS-live">
                            <a href="#0" class="subClick current">视讯直播</a>
                            <ul class="subList slidedown">
                                <li v-for="(lives, key) in lives" :class="key == 0 ? 'current' : ''"><a :href="lives.link">{{ lives.name }}</a></li>
                            </ul>
                        </li>
            ...
            <div class="page-title">
                <img src="image/lang/zh-cn/bg_03_m.png" class="tablet">
                <img src="image/lang/zh-cn/bg_03_s.png" class="mobile">
            </div>
        </div>
        <!-- page-container -->
