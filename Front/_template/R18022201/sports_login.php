    ...
    <div id="mainBody">
        ...
        <div id="page-header">
                ...
                <div class="mainnav">
                    <ul class="clearfix">
                        ...
                        <li id="LS-ball" class="LS-ball">
                            <a href="#0" class="subClick current">体育赛事</a>
                            <ul class="subList slidedown">
                                <li v-for="(ball, key) in balls" :class="key == 0 ? 'current' : ''"><a :href="ball.link">{{ ball.name }}</a></li>
                            </ul>
                        </li>
            ...
            <div class="page-title">
                <img src="image/lang/zh-cn/bg_02_m.png" class="tablet">
                <img src="image/lang/zh-cn/bg_02_s.png" class="mobile">
            </div>
        </div>
        <!-- page-container -->
