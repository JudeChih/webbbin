...
class ProjectDataRepository {
    ...
    public function getAllDataNew(){
        return ProjectData::where('pd_rwd',0)->where('pd_show',1)->where('isflag',1)->orderBy('pd_date','DESC')->get();
    }
    ...
    public function getDataById($pd_id){
    	return ProjectData::where("pd_id",$pd_id)->where('isflag',1)->first();
    }

    public function getPrevDataByDate($pd_date){
        return ProjectData::where('pd_date','<',$pd_date)->where('pd_rwd',0)->where('pd_show',1)->where('isflag',1)->orderBy('pd_date','DESC')->first();
    }

    public function getNextDataByDate($pd_date){
        try{
        return ProjectData::where('pd_date','>',$pd_date)->where('pd_rwd',0)->where('pd_show',1)->where('isflag',1)->orderBy('pd_date','ASC')->first();
    } catch (\Exception $e) {
    ...
    public function getLastData(){
        return ProjectData::where('isflag',1)->where('pd_rwd',0)->where('pd_show',1)->orderBy('pd_date','DESC')->first();
    }

    public function getFirstData(){
        return ProjectData::where('isflag',1)->where('pd_rwd',0)->where('pd_show',1)->orderBy('pd_date','ASC')->first();
    }
